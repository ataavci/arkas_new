...
const mainpageshow = function(req, res, next) {
    res.render("admin/yonetim", { layout: "layouts/yonetim_layouts.ejs" });
};

const fuelboard = function(req, res, next) {
    res.render("admin/fuel", { layout: "layouts/yonetim_layouts.ejs" });
};
const ukpageshow = function(req, res, next) {
    res.render("admin/uk-eu", { layout: "layouts/yonetim_layouts.ejs" });
};
const indicatorpageshow = function(req, res, next) {
    res.render("admin/indicator", { layout: "layouts/yonetim_layouts.ejs" });
};
...
const dashboardpage = async (req, res, next) => {
    try {
        ...
        res.render("admin/dashboard", {
            layout: "layouts/yonetim_layouts.ejs",
            tableData,
            totalConsumption,
...
const showBarGraphPage = (req, res) => {
    res.render('admin/barGraph', { layout: 'layouts/yonetim_layouts.ejs' });
};
...
const renderTaxAndEuaGraphPage = (req, res) => {
    res.render('admin/taxAndEuaGraph',{ layout: 'layouts/yonetim_layouts.ejs' }); // EJS dosyasını render eder
};
